...
var nam = 'ContentTemplateTabs';
if (!window[nam]) {
  window[nam] = {
    name: name,
    version: '0.1.0',
    className: 'content-template-tabs',
    classNameInit: 'content-template-tabs--initialised',
    ...
    screenLoad: function() {
      // Initialise all Content Template Tabs
      var self = this;
      ...
      $contentTemplates.each(function(){
        ...
        // Initialise sortable elements for tabs
      ...
      /** Event handlers for all ContentTemplateTabs (not delegated because it's unnecessary) **/
