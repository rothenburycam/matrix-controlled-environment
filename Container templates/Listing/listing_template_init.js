 ...
 */
var nam = 'ContentTemplateListing1';
if (!window[nam]) {
    window[nam] = {
        name: nam,
        version: '0.1.0',
...
console.log('before: window initialised');
if (!window[nam].initialised) {
    console.log('window initialised');
    window[nam].init();
}